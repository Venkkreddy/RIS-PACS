...
const schema = z.object({
  ...
  FIREBASE_PROJECT_ID: z.string().default("ris-pacs-client"),
  GCP_PROJECT_ID: z.string().default("ris-pacs-client"),
  GCS_BUCKET: z.string().default("ris-pacs-client.firebasestorage.app"),
...
export const env = {
  ...
  ENABLE_DEV_LOGIN: parsed.ENABLE_DEV_LOGIN === "true",
